...
java -jar $COMPILER $JSFILES_NO_WEB --compilation_level WHITESPACE_ONLY --js_output_file biwascheme_no_web_closure_compiled.js
java -jar $COMPILER $JSFILES_NO_WEB $JSFILES_WEB --compilation_level WHITESPACE_ONLY --js_output_file biwascheme_closure_compiled.js