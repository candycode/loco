...
void WINAPI RtlUnwindEx( FRAME_POINTERS TargetFrame,
   PVOID TargetIp,
  ...
  void *cf, CONTEXT *ctx, UndocumentedDispatcherContext *dispatch)
{
  ...
  if ((rec->ExceptionFlags & 6)) {  /* EH_UNWINDING|EH_EXIT_UNWIND */
	...
	return ExceptionContinueSearch;
      ...
      */
      /****UV==== converted cf from void* fo FRAME_POINTERS***/
      RtlUnwindEx(/*(*(FRAME_POINTERS*)*/ cf /*)*/, (void *)((cframe_unwind_ff(cf2) && errcode != LUA_YIELD) ?
			       lj_vm_unwind_ff_eh :
			       lj_vm_unwind_c_eh),
